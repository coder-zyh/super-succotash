		...
		<div class="page_content task-overdue_content">
			<div class="page-top_content task-overdue_content-top">
				<van-tabs @click="onClick">
					<van-tab title="催收中" name="collection"></van-tab>
					<van-tab title="已结清" name="settle"></van-tab>
				</van-tabs>
			</div>
			<div>
				<van-empty
...
export default defineComponent({
	...
	setup() {
		...
		function goPage(item) {
			// router.push(`/case-detail/${item.id}`);
			router.push({
